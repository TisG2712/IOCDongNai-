...
import { FaEdit, FaTrash, FaLock, FaLockOpen } from "react-icons/fa";
...
function UsersTable({ data, onEdit, onDelete, onToggleLock }) {
  return (
            ...
            {data.length === 0 ? (
              ...
              data.map((row, idx) => (
                <tr key={row.id} className={row.locked ? "bg-gray-200" : ""}>
                  ...
                  <td className="px-3 py-2 border-white border">{row.email}</td>
                  <td className="px-3 py-2 border-white border">
                    {row.dienThoai}
                  </td>
                  <td className="px-3 py-2 border-white border">
                    {row.maDonViHanhChinh}
                  </td>
                  <td className="px-3 py-2 border-white border">
                    {row.maDanToc}
                  </td>
                  ...
                  <td className="px-3 py-2 border-white border text-center">
                    {row.thoiGianKhoa ? formatDateTime(row.thoiGianKhoa) : ""}
                  </td>
                  <td className="px-3 py-2 border-white border">
