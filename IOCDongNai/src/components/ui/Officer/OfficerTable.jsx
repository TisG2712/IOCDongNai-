...
function OfficerTable({ data, onEdit, onDelete, onToggleLock }) {
  return (
            ...
            {data.length === 0 ? (
              ...
              data.map((row, idx) => (
                <tr key={row.id} className={row.locked ? "bg-gray-200" : ""}>
                  ...
                  <td className="px-3 py-2 border-white border">{row.viTri}</td>
                  <td className="px-3 py-2 border-white border">{row.maPB}</td>
                  <td className="px-3 py-2 border-white border">{row.maDT}</td>
                  <td className="px-3 py-2 border-white border">
                    {row.maDVHC}
                  </td>
